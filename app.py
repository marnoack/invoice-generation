...
LOGO_URL = "https://drive.google.com/file/d/128-xxKYi_GwI4MpT3Tr--fnl_pQ0MfQM/view?usp=drive_link" 
        ...
        <table class="header-table" style="border-radius: 5px 5px 0 0;">
            <tr>
                <td class="header-col text-center" style="width: 20%;">
                    <img src="https://drive.google.com/file/d/128-xxKYi_GwI4MpT3Tr--fnl_pQ0MfQM/view?usp=drive_link" class="logo-img" alt="Logo">
                </td>
